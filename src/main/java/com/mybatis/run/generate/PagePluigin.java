...
public class PagePluigin extends PluginAdapter {
	@Override
	public boolean modelExampleClassGenerated(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
		addLimit(topLevelClass, introspectedTable, "pageNo");
	...
	private void addLimit(TopLevelClass topLevelClass, IntrospectedTable introspectedTable, String name) {
		...
		if("limitStart".equals(name)){
			
			method.addBodyLine("return (this.pageNo-1)*this.pageSize;");
		}else{
	...
	public static void generate() {
		String config = PagePluigin.class.getClassLoader().getResource("mybatis-generator.xml").getFile();
